...
public class ComponentGuiDetailsRotationVisitor implements ComponentVisitorInterface<StackPane>{
    ...
    public StackPane visit(BatterySlot component) {
        ...
        String imagePath = "/org/polimi/ingsw/galaxytrucker/galaxy_trucker_imgs/pedineSegnalini/batteryCharge.png";
    ...
    public StackPane visit(CentralHousingUnit component) {
        String imagePath = "/org/polimi/ingsw/galaxytrucker/galaxy_trucker_imgs/pedineSegnalini/AstronautaPedina.png";
        Image segnalino = new Image(zUtils.class.getResource(imagePath).toExternalForm());
        //VBOX per gli indicatori batteria
        HBox hBox = new HBox();
        hBox.setSpacing(5);
    ...
    public StackPane visit(GenericCargoHolds component) {
        ...
        String imagePath = "/org/polimi/ingsw/galaxytrucker/galaxy_trucker_imgs/pedineSegnalini/vuoto.png";
        Image segnalino = new Image(zUtils.class.getResource(imagePath).toExternalForm());
        ImageView uno;
        ImageView due;
        ...
        for(int i=0; i< component.getnMaxContainers();i++){
            ...
            if( i < component.getGoods().size()){
                ...
                switch (component.getGoods().get(i).getColor()){
                    case YELLOW -> pathMerce = "/org/polimi/ingsw/galaxytrucker/galaxy_trucker_imgs/pedineSegnalini/merceGialla.png";
                    case RED -> pathMerce = "/org/polimi/ingsw/galaxytrucker/galaxy_trucker_imgs/pedineSegnalini/merceRossa.png";
                    case GREEN -> pathMerce = "/org/polimi/ingsw/galaxytrucker/galaxy_trucker_imgs/pedineSegnalini/merceVerde.png";
                    case BLUE -> pathMerce = "/org/polimi/ingsw/galaxytrucker/galaxy_trucker_imgs/pedineSegnalini/merceBlu.png";
    ...
    public StackPane visit(ModularHousingUnit component) {
        ...
        switch (component.getAlienColor()){
            case BROWN:
                imagePath = "/org/polimi/ingsw/galaxytrucker/galaxy_trucker_imgs/pedineSegnalini/AlienoMarronePedina.png";
                segnalino = new Image(zUtils.class.getResource(imagePath).toExternalForm());

                break;
            case PURPLE:
                imagePath = "/org/polimi/ingsw/galaxytrucker/galaxy_trucker_imgs/pedineSegnalini/AlienoViolaPedina.png";
                segnalino = new Image(zUtils.class.getResource(imagePath).toExternalForm());
                break;
            case EMPTY:
                imagePath = "/org/polimi/ingsw/galaxytrucker/galaxy_trucker_imgs/pedineSegnalini/AstronautaPedina.png";
                segnalino = new Image(zUtils.class.getResource(imagePath).toExternalForm());
                break;
        }
