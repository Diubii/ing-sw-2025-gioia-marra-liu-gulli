...
public class SingleLobbyInfo {
    ...
    public void setData(int ID, String host, int playerNum, int maxPlayers, Boolean isLearningMatch) {
        ...
        if(isLearningMatch){
            imgType = new Image(getClass().getResource("/org/polimi/ingsw/galaxytrucker/galaxy_trucker_imgs/sleepy.png").toExternalForm());
            imgMatchType.setImage(imgType);
        }
        else{
            imgType = new Image(getClass().getResource("/org/polimi/ingsw/galaxytrucker/galaxy_trucker_imgs/ganzo.png").toExternalForm());
            imgMatchType.setImage(imgType);
        }
    }
